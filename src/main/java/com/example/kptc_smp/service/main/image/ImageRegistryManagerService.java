...
public class ImageRegistryManagerService {
    private final ImageRegistryRepository imageRegistryRepository;
    private final ImageMapperService imageMapperService;

    public ImageResponseDto createTempRegistry(MultipartFile file, UUID fileId, String storagePath) {
        ...
        return imageMapperService.toImageResponse(registry);
    }
